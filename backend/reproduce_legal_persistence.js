...
require('dotenv').config(); // Local .env in backend/
...
async function runTest() {
    try {
        ...
        try {
            const saveRes = await makeRequest('PUT', `${API_URL}/${TEST_TYPE}`, token, { content: TEST_CONTENT });
            console.log('✅ Content saved. Response:', JSON.stringify(saveRes));
        } catch (e) {
        ...
        // console.log('Fetch response:', JSON.stringify(data1, null, 2));
